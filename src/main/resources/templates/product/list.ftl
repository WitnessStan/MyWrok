            ...
            <div class="row clearfix">
                <div class="col-md-12 column">
                    ...
                    <tr>
                        ...
                        <td>
                            <img height="100" width="100" src="https://pic.52112.com/icon/256/20181203/25750/1278043.png" alt="">
                        </td>
                        <td>
                        ...
                        <td>
                            <#if productInfo.getProductStatusEnum().message == "在架">
                                <a href="/sell/seller/product/off_sell?productId=${productInfo.productId}" onclick="return confirm('确定要下架？')">下架</a>
                            <#else>
                                <a href="/sell/seller/product/on_sell?productId=${productInfo.productId}" onclick="return confirm('确定要上架？')">上架</a>
                            </#if>
                        </td>
                    </tr>
                    </#list>
